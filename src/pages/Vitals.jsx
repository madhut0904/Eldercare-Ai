      ...
      <div className="bg-white rounded-3xl p-6 border border-slate-200/80 card-shadow space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-4">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-2xl bg-rose-100 text-rose-600 flex items-center justify-center text-xl shadow-sm">
              ❤️
            </div>
            <div>
              <h3 className="font-heading font-extrabold text-xl text-slate-900">Heart Rate Dynamics</h3>
              <p className="text-xs text-slate-500">Electrocardiogram non-invasive sensor stream</p>
            </div>
          </div>

          <div className="flex items-center gap-4 text-xs">
            <div className="bg-slate-50 px-3 py-1.5 rounded-xl border border-slate-200/80">
              Current: <strong className="text-rose-600 font-extrabold text-sm">{vitals.heartRate.current} BPM</strong>
            </div>
            <div className="bg-slate-50 px-3 py-1.5 rounded-xl border border-slate-200/80">
              Avg: <strong className="text-slate-800 font-bold">{vitals.heartRate.avg} BPM</strong>
            </div>
            <div className="bg-slate-50 px-3 py-1.5 rounded-xl border border-slate-200/80 hidden sm:block">
              Range: <strong className="text-slate-800 font-bold">{vitals.heartRate.min} - {vitals.heartRate.max} BPM</strong>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-3xl p-6 border border-slate-200/80 card-shadow space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-heading font-extrabold text-xl text-slate-900">Blood Oxygen (SpO₂) Saturation</h3>
              <p className="text-xs text-slate-500">Photoplethysmography sensor stream</p>
            </div>
          </div>

          <div className="flex items-center gap-4 text-xs">
            <div className="bg-slate-50 px-3 py-1.5 rounded-xl border border-slate-200/80">
              Current: <strong className="text-teal-600 font-extrabold text-sm">{vitals.spo2.current}%</strong>
            </div>
            <div className="bg-slate-50 px-3 py-1.5 rounded-xl border border-slate-200/80">
              Avg: <strong className="text-slate-800 font-bold">{vitals.spo2.avg}%</strong>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-3xl p-6 border border-slate-200/80 card-shadow space-y-4">
          <div className="flex items-center gap-3 border-b border-slate-100 pb-3">
            ...
            <div>
              <h3 className="font-heading font-extrabold text-lg text-slate-900">Blood Pressure (Systolic / Diastolic)</h3>
              <p className="text-xs text-slate-500">Optimal baseline: 120/80 mmHg</p>
            </div>
          </div>
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-xs text-slate-500 font-bold">mmHg ({vitals.bloodPressure.status})</span>
          </div>
        ...
        <div className="bg-white rounded-3xl p-6 border border-slate-200/80 card-shadow space-y-4">
          <div className="flex items-center gap-3 border-b border-slate-100 pb-3">
            ...
            <div>
              <h3 className="font-heading font-extrabold text-lg text-slate-900">Body Temperature</h3>
              <p className="text-xs text-slate-500">Thermal sensor stream</p>
            </div>
          </div>
          <div className="flex items-baseline gap-2">
            <span className="text-3xl font-extrabold text-slate-900">
            ...
            <span className="text-xs text-emerald-600 font-bold">({vitals.temperature.status})</span>
          </div>
          <div className="h-44 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={chartData} margin={{ top: 5, right: 5, left: -25, bottom: 0 }}>
                ...
                <Tooltip />
                <Area type="monotone" dataKey="temp" stroke="#f59e0b" fill="#fef3c7" strokeWidth={2.5} />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
