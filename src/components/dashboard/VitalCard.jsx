...
export default function VitalCard({
  ...
  const iconStyles = {
    ...
    cyan: 'bg-teal-100/70 text-teal-600'
  };
  ...
  return (
    <div className="bg-white rounded-3xl p-5 border border-slate-200/80 card-shadow card-shadow-hover flex flex-col justify-between relative overflow-hidden">
      ...
      <div className="pt-2 border-t border-slate-100 text-xs font-medium text-slate-500 flex items-center justify-between">
        <span>{trend}</span>
